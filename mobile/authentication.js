...
class Login extends Component {
            ...
            .map((provider, i) => {
              return (
                <TouchableHighlight
                  ...
                  onPress={this
                  .onBtnPressed
                  .bind(this, provider, this.props.secrets[provider])}>
  ...
  onBtnPressed(provider, opts) {
    ...
    simpleAuthProviders[provider](opts).then((info) => {
      ...
      _this.setState({loading: false});
      Alert.alert('Authorize Error', error.message);
    });
  }
